...
int32 AmountOfRewardsOnKillStreak[5] = { 1, 2, 3, 4, 5 }; //With how many items you want to reward the killer when he slays the victim.
...
void OnPVPKill(Player *pKiller, Player *pVictim)
{
    ...
    else if(PvPSystemEnabled)
    {
      ...
      if(LooseTokenOnPvPDeath == true)
        ...
        {
        case KillerStreak1:
        sprintf(msg, "[PvP 系统]: %s 杀死 %s 是他的第 %u 个杀敌. ", pKiller->GetName(), pVictim->GetName(), KillStreaks[1]);
        sWorld->SendWorldText(LANG_SYSTEMMESSAGE, msg);
        pKiller->AddItem(ItemReward, AmountOfRewardsOnKillStreak[1]);
        break;

        case KillerStreak2:
        sprintf(msg, "[PvP 系统]: %s 杀死 %s 是他的第 %u 个杀敌.. ", pKiller->GetName(), pVictim->GetName(), KillStreaks[2]);
        sWorld->SendWorldText(LANG_SYSTEMMESSAGE, msg);
        pKiller->AddItem(ItemReward, AmountOfRewardsOnKillStreak[2]);
        break;

        case KillerStreak3:
        sprintf(msg, "[PvP 系统]: %s 杀死 %s 是他的第 %u 个杀敌.. ", pKiller->GetName(), pVictim->GetName(), KillStreaks[3]);
        sWorld->SendWorldText(LANG_SYSTEMMESSAGE, msg);
        pKiller->AddItem(ItemReward, AmountOfRewardsOnKillStreak[3]);
        break;

        case KillerStreak4:
        sprintf(msg, "[PvP 系统]: %s 杀死 %s 是他的第 %u 个杀敌.. ", pKiller->GetName(), pVictim->GetName(), KillStreaks[4]);
        sWorld->SendWorldText(LANG_SYSTEMMESSAGE, msg);
        pKiller->AddItem(ItemReward, AmountOfRewardsOnKillStreak[4]);
        break;

        case KillerStreak5:
        sprintf(msg, "[PvP 系统]: %s 杀死 %s 是他的第 %u 个杀敌. ", pKiller->GetName(), pVictim->GetName(), KillStreaks[5]);
        sWorld->SendWorldText(LANG_SYSTEMMESSAGE, msg);
